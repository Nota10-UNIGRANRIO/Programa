...
#lista de perguntas
questions = [
    ["Quem ganhou a copa de 2022?", "França", "Brasil", "Italia", "Argentina", 4],
    ...
    ["Quem descobriu o Brasil?", "Pedro Álvares Cabral", "Abraham Lincoln", "Cristovão Colombo", "Juan Díaz de Solís", 1],
